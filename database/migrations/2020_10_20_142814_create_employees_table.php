...
class CreateEmployeesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('employees', function (Blueprint $table) {
            ...
            $table->string('job_no', 6)->default('')->comment('员工工号');
            $table->unsignedTinyInteger('department_id')->default(0)->comment('部门ID');
            $table->unsignedTinyInteger('group_id')->default(0)->comment('组别ID');
            $table->unsignedTinyInteger('job_id')->default(0)->comment('职务ID');
            ...
            $table->unsignedTinyInteger('nation_id')->default(0)->comment('民族');
            ...
            $table->text('work_experience')->nullable()->comment('员工工作经历');
            $table->text('exception_action')->nullable()->comment('员工异动记录');
            $table->text('leave_records')->nullable()->comment('员工休假记录');
            $table->text('remark')->nullable()->comment('员工备注');
            $table->timestamps();
        });
    }
