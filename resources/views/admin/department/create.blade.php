    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">创建新行政部门</div>
                ...
                <form class="layui-form" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" autocomplete="off" placeholder="请输入行政部门名称" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <textarea placeholder="请输入行政部门备注" name="remark" class="layui-textarea"></textarea>
                        </div>
                    </div>
...
<script>
    ...
    var routes = {
        departments: {
            ...
            store: '{{ route_uri('departments.store') }}',
        }
    };
    ...
    layui.use(['form'], function(){
        ...
        form.on('submit(form-submit)', function(obj){
            $.ajax({
                type: 'POST',
                url: route(routes.departments.store),
                data: obj.field,
                dataType: 'json',
                async: false,
