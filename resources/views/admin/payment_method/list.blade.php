                ...
                <div class="layui-card-body">
                    ...
                    <form class="" id="table-search-form" style="margin-bottom: 10px;">
                        ...
                        <div class="layui-inline">
                            <input class="layui-input" name="name" autocomplete="off" placeholder="支付方式名称">
                        </div>
                    ...
                    <script type="text/html" id="table-toolbar">
                        <div class="layui-btn-container">
                            <button class="layui-btn layui-btn-sm" lay-event="create">新增支付方式</button>
...
<script>
    ...
    var routes = {
        payment_methods: {
            data: '{{ route_uri('payment_methods.data') }}',
            create: '{{ route_uri('payment_methods.create') }}',
            edit: '{{ route_uri('payment_methods.edit') }}',
            delete: '{{ route_uri('payment_methods.delete') }}',
        }
    };
    ...
    layui.config({
        ...
        table.render({
            ...
            url: route(routes.payment_methods.data),
            cols: [[
        ...
        table.on('toolbar(data-table)', function(obj){
            switch (obj.event) {
                case 'create': {
                    makeLayerForm(layer, '{{ trans('tips.layer form title') }}', route(routes.payment_methods.create), function(){
        ...
        table.on('tool(data-table)', function(obj){
            switch (obj.event) {
                case 'edit': {
                    makeLayerForm(layer, '{{ trans('tips.layer form title') }}', route(routes.payment_methods.edit, {id: obj.data.id}), function(){
                        table.reload('data-table');
                    });
                }break;
                case 'delete': {
                    layer.confirm('{{ trans('tips.table delete confirm') }}', function(index){
                        $.ajax({
                            type: 'DELETE',
                            url: route(routes.payment_methods.delete),
                            data: {id: obj.data.id},
                            dataType: 'json',
                            async: false,
                            headers: {
