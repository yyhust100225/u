                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="table-toolbar">
                        <div class="layui-btn-container">
                            <button class="layui-btn layui-btn-sm" lay-event="create">新增开班公告</button>
...
<script>
    ...
    var routes = {
        class_announcements: {
            ...
            edit: '{{ route_uri('class_announcements.edit') }}',
            delete: '{{ route_uri('class_announcements.delete') }}',
        }
    };
            ...
            switch (obj.event) {
                ...
                case 'delete': {
                    layer.confirm('{{ trans('tips.table delete confirm') }}', function(index){
                        $.ajax({
                            type: 'DELETE',
                            url: route(routes.class_announcements.delete),
                            data: {id: obj.data.id},
                            dataType: 'json',
                            async: false,
                            headers: {
