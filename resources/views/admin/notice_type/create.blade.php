    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">创建新要讯类型</div>
                ...
                <form class="layui-form form-long-label-100" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" autocomplete="off" placeholder="请输入要讯类型名称" class="layui-input">
                        </div>
                    </div>
...
<script>
    ...
    var routes = {
        notice_types: {
            ...
            store: '{{ route_uri('notice_types.store') }}',
        }
    };
    ...
    layui.use(['form'], function(){
        ...
        form.on('submit(form-submit)', function(obj){
            $.ajax({
                type: 'POST',
                url: route(routes.notice_types.store),
                data: obj.field,
                dataType: 'json',
                async: false,
