                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="table-toolbar">
                        <div class="layui-btn-container">
                            <button class="layui-btn layui-btn-sm" lay-event="create">新增教师</button>
...
<script>
    ...
    var routes = {
        teachers: {
            data: '{{ route_uri('teachers.data') }}',
            create: '{{ route_uri('teachers.create') }}',
            edit: '{{ route_uri('teachers.edit') }}',
            delete: '{{ route_uri('teachers.delete') }}',
        }
    };
            ...
            switch (obj.event) {
                ...
                case 'delete': {
                    layer.confirm('{{ trans('tips.table delete confirm') }}', function(index){
                        $.ajax({
                            type: 'DELETE',
                            url: route(routes.teachers.delete),
                            data: {id: obj.data.id},
                            dataType: 'json',
                            async: false,
                            headers: {
