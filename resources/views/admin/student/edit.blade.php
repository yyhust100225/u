                    ...
                    <form class="layui-form" action="">
                        ...
                        <div class="layui-form-item">
                            <div class="layui-col-md8">
                                ...
                                <div class="layui-input-block">
                                    <input type="hidden" name="class_type_id" value="{{ $student->class_type_id }}" id="class-type-id">
                                    <input readonly type="text" name="class_type" value="{{ $student->class_type_name }}" id="class-type" placeholder="请选择考试+班型" class="layui-input" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="weighted_score" value="{{ $student->weighted_score }}"  id="weighted-score" autocomplete="off" placeholder="请输入笔试加权分" class="layui-input">
                            </div>
                        </div>
